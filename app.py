...
if m_status == "🔥 LIVE":
    # लाइव मार्केट में सिर्फ आज का सुपर-फास्ट डेटा
    df = yf.download(ticker, period="1d", interval="1m", progress=False)
else:
    # --- यहाँ कंपनी का नाम (Ticker) सेट करें ---
    ticker = "^NSEI"  # ^NSEI मतलब Nifty 50
    # बाज़ार बंद होने पर पिछले 5 दिनों का डेटा ताकि आप चार्ट देख सकें
